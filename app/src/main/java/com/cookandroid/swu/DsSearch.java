...
public class DsSearch extends AppCompatActivity
    ...
    static final int UPDATE_INTERVAL_MS = 2000;  // 1초
    static final int FASTEST_UPDATE_INTERVAL_MS = 1000; // 0.5초
    ...
    private View mLayout; // Snackbar 사용하기 위해서는 View 필요(Toast는 Context 필요)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 이전 마커 초기화 및 현재 위치 기준 약국 정보 보여주는 메소드 호출
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        //2. 퍼미션 요청을 허용한 적이 없다면 퍼미션 요청이 필요합니다. 2가지 경우(3-1, 4-1)
        else {
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.",
                    ...
                    public void onClick(View view) {
                        // 3-3. 사용자게에 퍼미션 요청, 결과는 onRequestPermissionResult에서 수신
                        ActivityCompat.requestPermissions( DsSearch.this, REQUIRED_PERMISSIONS,
...
//            Toast.makeText(this, "주소 미발견", Toast.LENGTH_LONG).show();
    ...
    public void onRequestPermissionsResult(int permsRequestCode,
        ...
        if (permsRequestCode == PERMISSIONS_REQUEST_CODE && grandResults.length == REQUIRED_PERMISSIONS.length) {
            ...
            // 퍼미션을 허용했다면
            if (check_result) {
                startLocationUpdates(); // 위치 업데이트를 시작
            }
            // 거부한 퍼미션이 있다면 앱을 사용할 수 없는 이유를 설명해주고 앱을 종료합니다. 2가지 경우
            else {
                if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])
                ...
                // "다시 묻지 않음"을 사용자가 체크하고 거부를 선택한 경우에는 설정(앱 정보)에서 퍼미션 허용 필요
                else {
